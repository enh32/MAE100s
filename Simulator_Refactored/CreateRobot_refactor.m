classdef CreateRobot_refactor < handle
...
% CreateMatlabSim@gmail.com
    ...
    % All units are kg/m/s/rad unless otherwise noted
        ...
        angleArray= linspace(-CreateRobot_refactor.angRangeLidar/2,CreateRobot_refactor.angRangeLidar/2,CreateRobot_refactor.numPtsLidar) %Array of LIDAR angles
    end
    ...
    % Constructor Function
        function obj= CreateRobot_refactor(varargin)
        % obj = CreateRobot
...
%%%%%%%%%%%%% Check if robot is sliding or is in pure rolling%%%%%%%%%%
    ...
    % Translator Functions
        ...
        %   Identical to the input argument in the simulator only
            ...
            if ~isa(obj,'CreateRobot_refactor')
